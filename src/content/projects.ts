...
export const projects: Project[] = [
  ...
  },
  {
    ...
    stack: ["Next.js", "TypeScript", "Tailwind", "Anthropic Claude", "Vercel"],
  ...
  },
  {
    ...
    description:
      "MIT-licensed suite of in-browser GTM tools for finding the companies and people you actually want to talk to. FastAPI + Python backend, Next.js frontend, Postgres, Redis. Self-hostable, BYOK, no servers store your data.",
    stack: [
      "Python",
      "FastAPI",
      "PostgreSQL",
